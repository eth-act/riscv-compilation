...
# Download binary
curl -L https://raw.githubusercontent.com/developeruche/stateless-block-exec/main/geth/geth_evm_riscv64_linux -o geth_evm_riscv64_linux
chmod +x geth_evm_riscv64_linux
